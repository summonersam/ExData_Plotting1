...
## Tell R we want 2 column and 2 rows of plots
par(mfrow = c(2,2))

## Plot global active power
plot(xy.coords(householdPCo$Global_active_power), type = "l",  xlab = "", ylab = "Global Active Power (killowatts)", 
            xlim = c(0, 3000), ylim = c(0,6), xaxt = "n", yaxt = "n")
 axis(1, at = c(0, 1500, 3000), labels = c("Thu", "Fri", "Sat"))
 axis(2, c(0,2,4,6))
 
 ##Plot voltage
 plot(xy.coords(householdPCo$Voltage), type = "l",  xlab = "datetime", ylab = "Voltage", 
             xlim = c(0, 3000), ylim = c(233,248), xaxt = "n", yaxt = "n")
 axis(1, at = c(0, 1500, 3000), labels = c("Thu", "Fri", "Sat"))
 ...
 legend(850, 41.58, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, bty = "n")
 
 ##Plot global reactive power
 plot(xy.coords(householdPCo$Global_reactive_power), type = "l",  xlab = "datetime", ylab = "Global_reactive_power", 
      xlim = c(0, 3000), ylim = c(0.0, 0.5), xaxt = "n", yaxt = "n")
 axis(1, at = c(0, 1500, 3000), labels = c("Thu", "Fri", "Sat"))
